...
public ResponseEntity createServiceRequest(@PathVariable Integer doctorId,@RequestBody @Valid ServiceReguest serviceReguest){
...
serviceReguestService.createRequest(serviceReguest,doctorId);
    ...
    public ResponseEntity updateServiceRequest( @PathVariable Integer requestId, @RequestBody @Valid ServiceReguest service) {

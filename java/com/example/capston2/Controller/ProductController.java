...
public class ProductController {
    ...
    @PostMapping("/add")
    public ResponseEntity addNewCat(@RequestBody @Valid Product product){
    ...
    public ResponseEntity updateCat(@PathVariable Integer id,@RequestBody @Valid Product product){
